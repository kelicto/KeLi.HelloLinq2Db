...
namespace DataModels
{
	...
	/// </summary>
	public partial class MyDatabaseDataConnection : LinqToDB.Data.DataConnection
	{
		public ITable<Student> Students { get { return this.GetTable<Student>(); } }

		public MyDatabaseDataConnection()
		{
			InitDataContext();
			InitMappingSchema();
		}

		public MyDatabaseDataConnection(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public MyDatabaseDataConnection(LinqToDbConnectionOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
